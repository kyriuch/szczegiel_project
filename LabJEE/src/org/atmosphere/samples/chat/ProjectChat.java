 ...
 */
@ManagedService(path = ProjectChat.PATH + "{projektId: [a-zA-Z][a-zA-Z_0-9]*}")//, atmosphereConfig = MAX_INACTIVE + "=120000")
public class ProjectChat {
	public final static String PATH = "/room/";
	
    private final Logger logger = LoggerFactory.getLogger(ProjectChat.class);
    ...
    public Message onMessage(Message message) throws IOException {
        logger.info("{} just sent {} (room: {})", message.getAuthor(), message.getMessage(), projektId);
        return message;
    }
